...
113 
114   \textcolor{keywordflow}{if} (N<=0) \textcolor{keywordflow}{throw} \hyperlink{class_p_r_o2_excepcio}{PRO2Excepcio}(\textcolor{stringliteral}{"Las celulas de los organismos del sistema han de tener N
       parametros (N>0)"});
115 
