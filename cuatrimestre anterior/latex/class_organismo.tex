...
\begin{DoxyCode}
108 \{
109   \textcolor{comment}{// Devuelve el valor del campo "maligno" del organismo correspondiente.}
110   \textcolor{keywordflow}{return} \hyperlink{class_organismo_a85a5d1b9d31fa209d1ed0d596dbbed61}{maligno};
111 \}
\end{DoxyCode}
...
\begin{DoxyCode}
114 \{
115   \textcolor{comment}{// Devuelve el valor del campo "victimas" del organismo correspondiente.}
116   \textcolor{keywordflow}{return} \hyperlink{class_organismo_abb3e56487a080df544a6ff96e5e42520}{victimas};
117 \}
\end{DoxyCode}
...
\begin{DoxyCode}
120 \{
121   \textcolor{comment}{// Esta operación simplemente lee la estructura celular del organismo e}
122   \textcolor{comment}{// inicializa el recuento de víctimas. Un árbol de células se lee igual que}
123   \textcolor{comment}{// un árbol de enteros. Suponemos que contamos con una marca de tipo Celula}
124   \textcolor{comment}{// para indicar que llegamos a un árbol vacío.}
125 
126   \textcolor{keywordflow}{if} (N<=0) \textcolor{keywordflow}{throw} \hyperlink{class_p_r_o2_excepcio}{PRO2Excepcio}(\textcolor{stringliteral}{"Las celulas del organismo han de tener N parametros (N>0)"});
127 
128   \hyperlink{class_organismo_abfafb8e55144e295b406ce90951f0c68}{celulas}.\hyperlink{class_arbre_aa74ec0d2b601487b822eb70100330582}{a\_buit}();
129   \hyperlink{class_organismo_abf016c166b00ca0f7016afd44d282913}{leer\_arbol\_celulas}(N, \hyperlink{class_organismo_abfafb8e55144e295b406ce90951f0c68}{celulas});
130   \hyperlink{class_organismo_a85a5d1b9d31fa209d1ed0d596dbbed61}{maligno} = \hyperlink{readbool_8hh_a56691e176645da552c107ef124ad701a}{readbool}();
131   \hyperlink{class_organismo_abb3e56487a080df544a6ff96e5e42520}{victimas} = 0;
132 \}
\end{DoxyCode}
...
\begin{DoxyCode}
147 \{
148   \textcolor{comment}{// Escribimos los campos del organismo.  Un árbol de células se escribe}
149   \textcolor{comment}{// igual que un árbol de enteros, suponiendo que (como es el caso) exista}
150   \textcolor{comment}{// una operación para escribir células.}
151   cout << \textcolor{keywordtype}{id} << \textcolor{stringliteral}{" "} << \hyperlink{class_organismo_abb3e56487a080df544a6ff96e5e42520}{victimas};
152   \textcolor{keywordflow}{if} (estr) \{
153     \hyperlink{class_arbre}{Arbre<Celula>} copia(\hyperlink{class_organismo_abfafb8e55144e295b406ce90951f0c68}{celulas});
154     \hyperlink{class_organismo_ad29f7f44a5694136d0a3990581426cf0}{escribir\_arbol\_celulas\_id}(copia);
155   \}
156   cout << endl;
157 \}
\end{DoxyCode}
...
\subsubsection[{\texorpdfstring{simetricos(\+Arbre$<$ Celula $>$ \&a1, Arbre$<$ Celula $>$ \&a2)}{simetricos(Arbre< Celula > &a1, Arbre< Celula > &a2)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Organismo\+::simetricos (
\begin{DoxyParamCaption}
\item[{{\bf Arbre}$<$ {\bf Celula} $>$ \&}]{a1, }
\item[{{\bf Arbre}$<$ {\bf Celula} $>$ \&}]{a2}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}\hypertarget{class_organismo_ac483b268b68eed06f612ed690c22af8f}{}\label{class_organismo_ac483b268b68eed06f612ed690c22af8f}
...
\begin{DoxyCode}
58 \{
59   \textcolor{keywordtype}{bool} b;
60   \textcolor{keywordflow}{if} (a1.\hyperlink{class_arbre_a68a51f6689f0b2889e8e1d56266fd620}{es\_buit}() or a2.\hyperlink{class_arbre_a68a51f6689f0b2889e8e1d56266fd620}{es\_buit}()) b = a1.\hyperlink{class_arbre_a68a51f6689f0b2889e8e1d56266fd620}{es\_buit}() and a2.
      \hyperlink{class_arbre_a68a51f6689f0b2889e8e1d56266fd620}{es\_buit}();
61   \textcolor{keywordflow}{else} \{
62     \hyperlink{class_arbre}{Arbre<Celula>} fe1, fe2, fd1, fd2; 
63     a1.\hyperlink{class_arbre_aee75355cee7599e132de75781d26a61d}{fills}(fe1,fd1); \textcolor{comment}{// fe1 = hi(A1); fd1 = hd(A2); a1 = buit }
64     a2.\hyperlink{class_arbre_aee75355cee7599e132de75781d26a61d}{fills}(fe2,fd2); \textcolor{comment}{// fe2 = hi(A2); fd1 = hd(A2); a2 = buit}
65     b = \hyperlink{class_organismo_ac483b268b68eed06f612ed690c22af8f}{simetricos}(fe1, fd2);
66     \textcolor{comment}{// HI1: b indica si hi(A1) y hd(A2) son simétricos}
67     \textcolor{keywordflow}{if} (b) \{ b = \hyperlink{class_organismo_ac483b268b68eed06f612ed690c22af8f}{simetricos}(fd1, fe2);
68              \textcolor{comment}{// HI2: b indica si hd(A1) y hi(A2) son simétricos}
69     \}
70   \}
71   \textcolor{keywordflow}{return} b;
72 \}
\end{DoxyCode}
\index{Organismo@{Organismo}!lucha\+\_\+arboles@{lucha\+\_\+arboles}}
\index{lucha\+\_\+arboles@{lucha\+\_\+arboles}!Organismo@{Organismo}}
\subsubsection[{\texorpdfstring{lucha\+\_\+arboles(\+Arbre$<$ Celula $>$ \&a1, Arbre$<$ Celula $>$ \&a2)}{lucha_arboles(Arbre< Celula > &a1, Arbre< Celula > &a2)}}]{\setlength{\rightskip}{0pt plus 5cm}pair$<$ int, int $>$ Organismo\+::lucha\+\_\+arboles (
\begin{DoxyParamCaption}
\item[{{\bf Arbre}$<$ {\bf Celula} $>$ \&}]{a1, }
\item[{{\bf Arbre}$<$ {\bf Celula} $>$ \&}]{a2}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}\hypertarget{class_organismo_aaf643a47840f855ed3e105970f75a078}{}\label{class_organismo_aaf643a47840f855ed3e105970f75a078}
...
\subsubsection[{\texorpdfstring{leer\+\_\+arbol\+\_\+celulas(int N, Arbre$<$ Celula $>$ \&a)}{leer_arbol_celulas(int N, Arbre< Celula > &a)}}]{\setlength{\rightskip}{0pt plus 5cm}void Organismo\+::leer\+\_\+arbol\+\_\+celulas (
\begin{DoxyParamCaption}
\item[{int}]{N, }
\item[{{\bf Arbre}$<$ {\bf Celula} $>$ \&}]{a}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}\hypertarget{class_organismo_abf016c166b00ca0f7016afd44d282913}{}\label{class_organismo_abf016c166b00ca0f7016afd44d282913}
...
\begin{DoxyCode}
135 \{
136   \hyperlink{class_arbre}{Arbre<Celula>} a1, a2;
137   \hyperlink{class_celula}{Celula} c;
138   c.\hyperlink{class_celula_a5124ea0c0da24dfc295dcc428652ee43}{leer}(N);
139   \textcolor{keywordflow}{if} (not c.\hyperlink{class_celula_a4e97c60a207191b2cc951ccdf245df4b}{es\_vacia}()) \{
140     \hyperlink{class_organismo_abf016c166b00ca0f7016afd44d282913}{leer\_arbol\_celulas}(N, a1);
141     \hyperlink{class_organismo_abf016c166b00ca0f7016afd44d282913}{leer\_arbol\_celulas}(N, a2);
142     a.\hyperlink{class_arbre_a806d45f6f1d3a9dd357563979186f721}{plantar}(c, a1, a2);
143   \}
144 \}
\end{DoxyCode}
...
\subsubsection[{\texorpdfstring{escribir\+\_\+arbol\+\_\+celulas\+\_\+id(\+Arbre$<$ Celula $>$ \&a)}{escribir_arbol_celulas_id(Arbre< Celula > &a)}}]{\setlength{\rightskip}{0pt plus 5cm}void Organismo\+::escribir\+\_\+arbol\+\_\+celulas\+\_\+id (
\begin{DoxyParamCaption}
\item[{{\bf Arbre}$<$ {\bf Celula} $>$ \&}]{a}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}\hypertarget{class_organismo_ad29f7f44a5694136d0a3990581426cf0}{}\label{class_organismo_ad29f7f44a5694136d0a3990581426cf0}
...
\begin{DoxyCode}
160 \{
161   \textcolor{keywordflow}{if} (not a.\hyperlink{class_arbre_a68a51f6689f0b2889e8e1d56266fd620}{es\_buit}()) \{
162     \hyperlink{class_arbre}{Arbre<Celula>} a1, a2;
163     \hyperlink{class_celula}{Celula} aux = a.\hyperlink{class_arbre_aa6e2559ead7dfceda962cff11fb1a15c}{arrel}();
164     a.\hyperlink{class_arbre_aee75355cee7599e132de75781d26a61d}{fills}(a1,a2);    
...
\subsubsection[{\texorpdfstring{celulas}{celulas}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Arbre}$<${\bf Celula}$>$ Organismo\+::celulas\hspace{0.3cm}{\ttfamily [private]}}\hypertarget{class_organismo_abfafb8e55144e295b406ce90951f0c68}{}\label{class_organismo_abfafb8e55144e295b406ce90951f0c68}
